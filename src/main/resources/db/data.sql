...
-- 2. Post 시드 데이터 주입
MERGE INTO posts (id, user_id, external_id, user_key, title, content, image_url, deleted_at, created_at, updated_at) KEY(id, user_id)
...
MERGE INTO post_stat (post_id, id2, like_count, comment_count, view_count) KEY(post_id, id2)
VALUES (1, 1, 0, 1, 0);
