...
public record PostUpdateRequest(
        @Pattern(regexp = PostValidationConstants.NOT_BLANK_IF_PRESENT_PATTERN, message = "제목은 공백일 수 없습니다.")
        @Size(max = PostValidationConstants.TITLE_MAX_LENGTH, message = "제목은 최대 100자까지 입력 가능합니다.")
        String title,

        @Pattern(regexp = PostValidationConstants.NOT_BLANK_IF_PRESENT_PATTERN, message = "내용은 공백일 수 없습니다.")
